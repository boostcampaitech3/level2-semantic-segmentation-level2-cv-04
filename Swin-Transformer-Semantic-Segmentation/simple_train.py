...
def main(config_train):
	...
	if config_train['data_dir_root']:
		...
		cfg.data['train']['ann_dir']=os.path.join(config_train['data_dir_root'],'labels') #'annotations/training')
		cfg.data['val']['img_dir']=os.path.join(config_train['data_dir_root'],'images') #/validation')
		cfg.data['val']['ann_dir']=os.path.join(config_train['data_dir_root'],'labels') # 'annotations/validation')
